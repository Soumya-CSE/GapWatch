...
- **Interactive Supervisory Dashboard:** Intuitive drill-down capabilities from macro entity-risk scores down to individual case evidence logs.
...
4. **Presentation (`dashboard/app.py`):** Queries `sat_sa.db` via Streamlit to render sortable risk tables, Plotly visualizations, and auditable case evidence views.
...
* [ ] **"Negative Space" Detection:** Implement statistical algorithms to detect missing telemetry categories or unexpected periods of zero alerts.
